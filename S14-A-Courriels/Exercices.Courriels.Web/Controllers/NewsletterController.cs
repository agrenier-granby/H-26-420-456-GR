...
using Exercices.Courriels.Web.ViewModels;
using Microsoft.AspNetCore.Mvc;

namespace Exercices.Courriels.Web.Controllers
{
    public class NewsletterController(INewsletterService newsletterService, ApplicationDbContext context, IEmailSender emailSender) : Controller
    {
        ...
        [HttpPost]
        public async Task<ActionResult> Subscribe(NewsletterSubscriberVM vm)
        {
            ...
            await _emailSender.Send(vm.Email, "Test", "Ceci est un test.");

            TempData["Message"] = "Vous êtes maintenant abonné à notre infolettre!";
