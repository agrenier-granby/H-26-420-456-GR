...
namespace Exercices.Middlewares.Migrations
{
    ...
    [Migration("20260428162041_AjouterPaysDepartementsEmployes")]
    partial class AjouterPaysDepartementsEmployes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Exercices.Middlewares.Models.Departement", b =>
                {
            ...
            modelBuilder.Entity("Exercices.Middlewares.Models.Employe", b =>
                {
            ...
            modelBuilder.Entity("Exercices.Middlewares.Models.Pays", b =>
                {
                    b.Property<int>("PaysId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Exercices.Middlewares.Models.Employe", b =>
                {
                    b.HasOne("Exercices.Middlewares.Models.Departement", "Departement")
                        .WithMany("Employes")
                        .HasForeignKey("DepartementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Exercices.Middlewares.Models.Pays", "PaysOrigine")
                        .WithMany("Employes")
